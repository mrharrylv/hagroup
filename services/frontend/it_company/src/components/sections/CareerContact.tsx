  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      <div className="bg-white dark:bg-zinc-900/30 rounded-2xl sm:rounded-[2.5rem] p-5 sm:p-8 md:p-12 border border-zinc-200 dark:border-zinc-800 shadow-sm">
        ...
        {/* Form. POST: should the browser ever send it natively, what was typed
            stays out of the URL, the history and the server logs. */}
        <form method="post" className="max-w-2xl mx-auto" onSubmit={handleSubmit}>
          {/* Disabled until React has hydrated the prerendered form: text typed
              before then would stay on screen but never reach the state that
