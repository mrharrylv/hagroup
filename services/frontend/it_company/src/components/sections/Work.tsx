...
export default function Work() {
  ...
  return (
    <section id="work" className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      <div className="relative overflow-hidden p-6 sm:p-10 md:p-12 rounded-2xl sm:rounded-[2.5rem] bg-zinc-50/80 dark:bg-zinc-900/30 border border-zinc-200/70 dark:border-zinc-800/50">
